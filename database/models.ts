...
export class Profile extends Model {
  ...
  @field('best_streak') best_streak!: number;
  @field('is_premium') is_premium!: boolean;
  @field('step_goal') step_goal!: number;
  @field('water_goal_ml') water_goal_ml!: number;
  @field('calorie_goal') calorie_goal!: number;
  @field('sleep_goal_hours') sleep_goal_hours!: number;
  @field('wake_time_minutes') wake_time_minutes!: number;
  @field('sleep_time_minutes') sleep_time_minutes!: number;
  @field('sync_status') sync_status!: string | null;
...
export class WaterLog extends Model {
  ...
  @field('logged_date') logged_date!: string | null;
