...
export function buildDailyContextBrief(input: {
  ...
  if (
    ...
    return {
      ...
      prompt: 'Ajustame el día con foco en recuperación.',
    };
  }
  ...
  if (
    ...
    return {
      ...
      bullets: [
        ...
        calories > 0 ? `Calorías del día: ${calories}.` : 'Todavía falta cerrar la ingesta del día.',
      ],
  ...
  return {
    ...
    prompt:
      protein < 70
        ...
        : 'Resume mi día y dime qué priorizar ahora.',
  };
}
  ...
  switch (trigger) {
    case 'progress_trends':
      return {
        ...
        title: 'La lectura completa ya esta abierta',
        body:
          'Cruza peso, sueño, estado diario y entrenamiento para entender qué te está moviendo de verdad, no solo ver curvas sueltas.',
    ...
    case 'barcode_limit':
      return {
        ...
        body:
          'Ya no existe una versión paga para destrabar este flujo. Si alcanzas el tope diario, la alternativa es esperar al siguiente día o cargar manualmente.',
    ...
    case 'sleep_insights':
      return {
        eyebrow: 'Sueño con más contexto',
        title: 'Lee como tu descanso impacta el resto del sistema',
        body:
          'La lectura profunda entre sueño, estado diario y rendimiento ya está incluida en la app.',
