...
export const OnboardingStrings = {
  ...
  step5: {
    ...
    subtitle: "Cobro inmediato al confirmar en PayPal. No hay periodo de prueba gratuito. Cancelás la renovación cuando quieras.",
    features: {
    ...
    freeNote:    "Gratis con anuncios y funciones básicas. Sin prueba Premium.",
  },
  next:   "Siguiente",
  back:   "Atrás",
  skip:   "Omitir",
