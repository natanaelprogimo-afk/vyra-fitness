export const ErrorMessages = {
  ...
  paypalError: 'Hubo un problema con el pago. No se cobró nada.',
  ...
  premiumRequired: 'Esta función forma parte de Premium.',
...
export const AuthStrings = {
  welcome: {
    title: 'Entrena hoy.',
    subtitle: 'Sin excusas. Sin dashboards.',
    cta: 'Empezar gratis',
...
export const OnboardingStrings = {
  ...
  step5: {
    title: 'Premium',
    subtitle: 'Funciones avanzadas, sin economía virtual y sin ruido.',
    features: {
    ...
    monthly: '$12.99/mes',
    yearly: '$99.99/año',
    yearlyNote: 'Ahorro anual',
    trialCta: 'Ir al checkout de PayPal',
    freeCta: 'Continuar gratis',
    freeNote: 'Versión gratuita con funciones base.',
  },
  next: 'Siguiente',
  back: 'Atrás',
  skip: 'Omitir',
