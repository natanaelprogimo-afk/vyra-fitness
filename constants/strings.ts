...
export const ErrorMessages = {
  ...
  premiumRequired: "Esta función es Premium. ¡Probala 7 días gratis sin costo!",
...
export const OnboardingStrings = {
  ...
  step5: {
    title:    "Probá Premium\n7 días gratis",
    subtitle: "Sin cargo hasta que termine el trial. Cancelás cuando quieras.",
    features: {
      aiCoach:      "Coach IA con memoria real",
      photoLog:     "Log de comida por foto",
      voiceLog:     "Log de comida por voz",
    ...
    trialCta:    "Empezar prueba gratis de 7 días",
